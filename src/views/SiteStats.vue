<template>
  ...
  >
    ...
    >
      <v-col cols="9">
        <div v-for="stage in stats.totalStageTimes">
          {{ stage.stageId }} | {{ stage.times }}
        </div>
      </v-col>
      <v-col cols="3">
        <BackdropCard>
          ...
          <v-card-title class="display-2">
            <span class="monospace">{{ stats.totalApCost.toLocaleString() }}</span>
          </v-card-title>
          <v-card-subtitle class="subtitle-2 d-flex align-baseline">
