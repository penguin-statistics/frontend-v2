    ...
    content () {
      if (special.fool.enabled()) {
        const fool = {
          ...
          "ja": {
            "intro": {
              ...
              "intro_1": "Reunion Statisticsはレユニオン・ムーブメントのデータ処理部門であり、各作戦での素材在庫の統計分析を行っています。",
        ...
        return {
          ...
          subtitle: [
            fool[this.$i18n.locale]["intro"]["intro_1"],
...
.line-height-wide {
  ...
  .theme--light .drop-shadow {
    filter: drop-shadow(0 0 5px rgba(255, 255, 255, .5)) invert(1);
  }
</style>
