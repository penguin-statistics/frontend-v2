<i18n>
{
  "en": {
    "donate": {
      "donate_0": "Increasing number of users and server fees are putting Reunion Movement into crisis. In order to protect our beloved Reunion Movement, the webmaster decided to...",
