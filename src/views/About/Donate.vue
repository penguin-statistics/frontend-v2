<i18n>
{
  "en": {
    "donate": {
      "donate_0": "Increasing number of users and server fees are putting ℝeunion Movement into crisis. In order to protect our beloved ℝeunion Movement, the webmaster decided to...",
  ...
  "ja": {
    "donate": {
      "donate_0": "ユーザー数が急増し、サーバーの月額は上昇、レユニオン・ムーブメントの運営は危機的状況に...。管理人の紅白は大好きなレユニオン・ムーブメントを守るため、自分に出来ることは何か？紅白が悩んで見つけ出した答えは「アイドルになること」！？",
  ...
  "zh": {
    "donate": {
      "donate_0": "用户量激增，服务器月费上涨，整合数据的运营陷入了危机。站长红白为了保护喜爱的整合数据而决定...",
