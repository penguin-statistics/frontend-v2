...
## 后续版本更新公告
为彻底解决多次 Down、加载逐渐缓慢、本地缓存使用较多、界面使用卡顿、数据更新延迟逐渐增大等问题，企鹅物流数据统计的全新版本已于 2021 年 8 月并入开发计划、且后端部分已于近期基本完成。前端与原生 App 也已于开发计划中，后续的上线计划欢迎各位用户继续关注，我们会于官方 Mew 据点、bilibili 账号与 Twitter 账号下不定时同步开发进度。大家的反馈都有在听的！w
          `,
        },
        {
          version: "v3.6.4",
...
## 优化
1. 韩语支持 (Improved Korean - \`ko\` i18n Support)
          `,
        },
        {
          version: "v3.6.2",
...
`,
        ...
        },
        {
          ...
          changes: ["修改：由于监管要求，将于 `CN` 镜像暂时关闭首页的相作战片"],
        },
        {
          version: "v3.3.2",
        ...
        },
        {
          ...
          hotfix: ["修复：掉落汇报移除错误文案", "修复：掉落趋势图轴刻度区间"],
        },
        {
          version: "v1.1.11",
        ...
        },
        {
          ...
          changes: ["重构：ArkPlanner"],
        },
        {
          version: "v1.1.2",
          date: "2020-02-27T06:32:40Z",
          changes: ["添加：韩语支持", "添加：载入界面"],
        },
        {
          version: "v1.1.1",
          date: "2020-02-08T21:14:04Z",
          changes: ["优化：“岁过华灯” 等一系列开箱子的汇报支持批量上传"],
        },
        {
          version: "v1.1.0",
