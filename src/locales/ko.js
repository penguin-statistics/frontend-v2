const messages = {
  ...
  "meta": {
    ...
    "footer": {
      "copyright": {
        "title": "라이센스",
        "content": "데이터는 펭귄 물류 데이터 분석 부서에 의하여 수집되었으며, 크리에이티브 커먼즈 저작자표시-비영리 4.0 국제 라이센스를 따릅니다. 재배포 혹은 변경시 적절한 출처와 라이센스 링크를 제공하여야 하며, 상업적 용도로 사용할 수 없습니다."
      },
  ...
  "stats": {
    ...
    "headerDesc": {
      ...
      "clearTime": "이 스테이지를 클리어하기 위해 필요한 가장 짧은 시간 - 작전 시작과 마지막 적 출현의 시간 간격. 출처: [PRTS Wiki]({prtsLink}).",
      "itemPerTime": "“백분율”을 계산해 두었으므로 시간 기대치를 계산할 수 있습니다. (클리어 시간 / (드랍 수 / 표본 수))",
      "timeRange": "이 스테이지의 드랍 테이블 변화로 인해서, 해당하는 줄의 데이터는 드랍 테이블의 가장 마지막 변화 시점 이후의 데이터만 집계되며, “집계 기간”으로 표시됩니다."
    },
    "filter": {
      "title": "필터",
    ...
    "site": {
      ...
      "generating": {
        "title": "사이트 데이터 생성 중...",
        "subtitle": "신경 네트워크 메시지: 데이터의 양이 많아 약 5분간의 계산이 필요합니다. 조금 뒤 다시 와 주세요.",
        "refresh": "사이트 통계 새로고침"
      }
    }
  },
  "contribute": {
    ...
    "frontend": "프론트엔드",
    "backend": "백엔드",
    "contribute_0": "다음 기술 중 하나라도 경험이 있고, 펭귄 물류에 기여하고자 한다면. QQ 그룹: 747099627로 연락하여 주십시오.",
  ...
  "fetch": {
    ...
    "failed": {
      ...
      "subtitle": "신경 네트워크와 연결할 수 없습니다. 일부 혹은 모든 정보를 불러올 수 없습니다.",
      "retry": "재시도",
      "deploying": "최신 버전을 배포하는 중입니다. 최대 5분이 걸릴 수 있으니 인내심을 갖고 기다려 주세요.",
      "error": {
        "zones": "구역 데이터",
        "stages": "스테이지 데이터",
        "items": "아이템 데이터",
  ...
  "report": {
    ...
    "recognition": {
      ...
      "tips": {
        ...
        "abnormal": "{count}개의 이미지가 판독성 검사를 통과하지 못하거나 인식되지 않아 \"제외\" 처리되었습니다",
      ...
      "description": "클리어 스크린샷을 올리기만 하면 자동으로 결과가 식별되어 보고서를 작성할 수 있습니다.",
      "recognize": {
        "noFilename": "파일 이름 없음",
        "elapsed": "소모 시간",
        "remaining": "남은 시간",
      ...
      "report": {
        ...
        "partialFailed": "{count}개의 작전 결과를 제출하지 못했습니다. 오류를 해결하기 위해서 다음을 확인해 주세요",
        "partialFailedDesc": [
        ...
        "caption": "제출에 감사드립니다. 캐시로 인해서 최대 20분 안에 전체 데이터에 추가되어 나타날 것입니다."
      },
      "states": {
        "pending": "초기화 대기 중...",
        "initializing": "초기화 중...",
      ...
      "exceptions": {
        ...
        "StageChar::LowConfidence": {
          "title": "스테이지 인식 오류",
          "subtitle": "인식 결과의 신뢰성이 낮습니다. 인식 결과가 이미지와 일치하는지 확인하세요."
        },
        ...
        "DropAreaDropsQuantity::NotFound": {
          "title": "드랍 인식 실패",
          "subtitle": "낮은 해상도 또는 화질의 이미지로 인해 발생할 수 있습니다. 이미지가 압축되지는 않았는지 확인하세요."
        },
        ...
        "DropAreaDrops::Illegal": {
          "title": "잘못된 드랍",
          "subtitle": "스테이지에서 드랍되어서는 안 되는 드랍이 스크린샷에 있습니다. 주로 이벤트 기간이 아닐 때 이벤트 드랍이 있는 경우입니다."
        },
        "Result::False": {
          "title": "작전 결과 화면이 아님",
          "subtitle": "작전 결과 화면이 맞는다면, 데이터 서버가 정확한지 확인해 주세요."
        },
        "Stage::NotFound": {
          "title": "유효한 스테이지를 찾을 수 없음",
          "subtitle": "스테이지 식별 오류이거나, 펭귄 물류가 해당 스테이지의 드랍을 집계하지 않는 경우입니다."
        },
        "Stage::Illegal": {
          "title": "잘못된 스테이지",
        ...
        "DropType::Illegal": {
          "title": "잘못된 드랍 분류",
          "subtitle": "첫 드랍이나 이성 반환 등 잘못된 드랍 분류가 스크린샷에 있습니다."
        },
    ...
    "closedReason": {
      ...
      "NOT_FOUND": "스테이지 없음: 선택된 서버에 해당 스테이지가 존재하지 않습니다.",
      "EXPIRED": "제출 가능 기간이 아님: 스테이지가 이미 닫혔거나 아직 열리지 않았습니다."
    },
  ...
  "mirrors": {
    ...
    "_notification": {
      "ignore": {
        ...
        "subtitle": "정말로 모든 미러 최적화 알림을 끄시겠습니까? 접속 속도 문제가 발생할 수 있습니다."
      }
    }
  },
  "settings": {
    ...
    "optimization": {
      "lowData": {
        ...
        "subtitle": "데이터 절약 모드는 스테이지 선택 시의 구역 배경 이미지나 웹사이트의 배경 이미지같은 불필요한 리소스 요청을 줄여 데이터 사용량을 줄이도록 도와줍니다."
      }
    },
    "data": {
      ...
      "reset": {
        ...
        "subtitle": "이 작업은 모든 로컬 데이터를 삭제하고 설정을 초기화할 것입니다. 초기화 후, 모든 설정이 기본값으로 돌아가며, 모든 데이터를 다시 다운로드해야 하고, 웹페이지가 새로고침될 것입니다. 정말로 계속하시겠습니까?"
      }
    }
  },
  "zone": {
  ...
  "planner": {
    "notices": {
      "autoExistence": "ArkPlanner는 이제 존재하지 않거나 닫혀 있는 스테이지를 자동으로 숨깁니다."
    },
    "options": {
      "_name": "설정",
      "byProduct": "부산물 획득 고려",
    ...
    "reset": {
      ...
      "dialog": {
        "title": "플래너 초기화",
        "subtitle": "이 작업은 플래너 데이터와 선택한 설정을 초기화할 것입니다. 정말로 계속하시겠습니까?",
        "options": {
          "options": {
            "name": "플래너 옵션",
            "indicator": "옵션 모두 초기화"
  ...
  "query": {
    "panel": {
      ...
      "results": "쿼리 결과",
      "footer": {
        "cache": "현재 표시되는 쿼리 결과는 캐시 데이터입니다. 최신 데이터를 얻으려면 “쿼리 실행”을 다시 눌러주세요.",
  ...
  "version": {
    "upgrade": {
      "title": "오래된 버전",
      "subtitle": "클라이언트 버전이 업데이트로 인해 만료되었습니다. 업데이트 후 다시 시도해 주세요.",
      "action": "업데이트",
      "unable": "업데이트할 수 없나요?"
    }
  },
