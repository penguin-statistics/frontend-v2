const messages = {
  ...
  "contribute": {
    ...
    "caption": "Penguin Statistics is a community project and it wouldn't be possible without the support of our community. Please support us by starring our GitHub repositories. Issues and PRs are always welcome!",
    "contribute_0": "If you have experience with any of the following, and want to contribute to Penguin Statistics, contact us at QQ group: 747099627 or Discord via the link below.",
  ...
  "mirrors": {
    "global": {
      "notification": "For performance concerns, we recommend you to use the global site {0}."
    },
    "cn": {
      "notification": "For performance concerns, we recommend you to use the CN mirror site {0}."
    },
    "_notification": {
      "ignore": {
  ...
  "query": {
    "panel": {
      ...
      "footer": {
        ...
        "disclaimer": "Any data produced by the \"Advanced Query\" function is protected by the \"Data License Agreement\" of this site. Penguin Statistics does not make any form of commitment or endorsement of any data produced."
      }
    },
    "title": {
      "main": "Main Query",
