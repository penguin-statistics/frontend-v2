...
const stages = new ObjectManager({
  ...
  transform: [
    (object) => {
      ...
      // object.push({"stageType":"ACTIVITY","stageId":"test01_003","zoneId":"test01","code":"测试活动 3","code_i18n":{"ko":"测试活动 3 ko","ja":"测试活动 3 ja","en":"测试活动 3 en","zh":"测试活动 3 zh 无dropInfos"},"apCost":6})
      //
      // object.push({"stageType":"ACTIVITY","stageId":"test02_001","zoneId":"test02","code":"测试活动 2 1","code_i18n":{"ko":"测试活动 2 1 ko","ja":"测试活动 2 1 ja","en":"测试活动 2 1 en","zh":"测试活动 2 1 zh 无dropInfos"},"apCost":6})
      // object.push({"stageType":"ACTIVITY","stageId":"test02_002","zoneId":"test02","code":"测试活动 2 2","code_i18n":{"ko":"测试活动 2 2 ko","ja":"测试活动 2 2 ja","en":"测试活动 2 2 en","zh":"测试活动 2 2 zh 无dropInfos"},"apCost":6})
      // object.push({"stageType":"ACTIVITY","stageId":"test02_003","zoneId":"test02","code":"测试活动 2 3","code_i18n":{"ko":"测试活动 2 2 ko","ja":"测试活动 2 2 ja","en":"测试活动 2 2 en","zh":"测试活动 2 3 zh 空dropInfos"},"apCost":6,"dropInfos":[]})
      return object
    }
  ],
